<?php
    ...
    if(isset($submitBTN)){
        $sql = "INSERT INTO $tbName(emp_id, days_worked, basic_salary, canteen_fees, pagibig, philhealth, sss, grosspay, tot_exp, netpay)  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        mysqli_stmt_bind_param($stmt, "siiiiiiiii", $selStaff, $dWorked, $dWage, $cAllowance,
        $pagibig, $philHealth, $sss, $grosspay, $tot_exp, $netpay);
