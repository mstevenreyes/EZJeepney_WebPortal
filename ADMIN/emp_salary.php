                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div style="display:flex">
                            ...
                            <h3 class="box-title">Pay Slip Record</h3>
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap" id="project">
                                    <thead>
                                        <tr>
                                            <th class="border-top-0" style="color:blue">Employee</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border-top-0">Driver</td>
                                            <td class="border-top-0">1000</td>
                                            <td><a class = "btn btn-sm btn-primary" href="salary_report.php">Generate Slip </a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-top-0">PAO</td>
                                            <td class="border-top-0">800</td>
                                            <td><a class = "btn btn-sm btn-primary" href="salary_report.php">Generate Slip </a></td>
                                        </tr>
                                    </tbody>
                                </table>
